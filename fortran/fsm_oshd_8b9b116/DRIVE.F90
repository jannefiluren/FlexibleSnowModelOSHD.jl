...
use MODCONF, only: CANMOD, ALRADT, OSHDTN, SNTRAN
...
read(804,pos=where,IOSTAT=eastatus) ((Sdir(i,j),i=1,Nx),j=1,Ny)
inquire(unit=805, pos=where)
read(805,pos=where,IOSTAT=eastatus) ((Sdif(i,j),i=1,Nx),j=1,Ny)
inquire(unit=806, pos=where)
read(806,pos=where,IOSTAT=eastatus) ((LW(i,j),i=1,Nx),j=1,Ny)
inquire(unit=807, pos=where)
read(807,pos=where,IOSTAT=eastatus) ((Sf(i,j),i=1,Nx),j=1,Ny)
inquire(unit=808, pos=where)
read(808,pos=where,IOSTAT=eastatus) ((Rf(i,j),i=1,Nx),j=1,Ny)
inquire(unit=809, pos=where)
read(809,pos=where,IOSTAT=eastatus) ((Ta(i,j),i=1,Nx),j=1,Ny)
inquire(unit=810, pos=where)
read(810,pos=where,IOSTAT=eastatus) ((RH(i,j),i=1,Nx),j=1,Ny)
inquire(unit=811, pos=where)
read(811,pos=where,IOSTAT=eastatus) ((Ua(i,j),i=1,Nx),j=1,Ny)
inquire(unit=812, pos=where)
read(812,pos=where,IOSTAT=eastatus) ((Ps(i,j),i=1,Nx),j=1,Ny)
inquire(unit=813, pos=where)
read(813,pos=where,IOSTAT=eastatus) ((Sf24h(i,j),i=1,Nx),j=1,Ny)
if (CANMOD == 1) then
  inquire(unit=814, pos=where)
  read(814,pos=where,IOSTAT=eastatus) ((Tv(i,j),i=1,Nx),j=1,Ny)
endif
if (SNTRAN == 1) then
  inquire(unit=815, pos=where)
  read(815,pos=where,IOSTAT=eastatus) ((Udir(i,j),i=1,Nx),j=1,Ny)
endif
if (Z0PERT) then
  inquire(unit=816, pos=where)
  read(816,pos=where,IOSTAT=eastatus) ((z0P(i,j),i=1,Nx),j=1,Ny)
endif
if (WCPERT) then
  inquire(unit=817, pos=where)
  read(817,pos=where,IOSTAT=eastatus) ((wcP(i,j),i=1,Nx),j=1,Ny)
endif
if (FSPERT) then
  inquire(unit=818, pos=where)
  read(818,pos=where,IOSTAT=eastatus) ((fsP(i,j),i=1,Nx),j=1,Ny)
endif
if (ALPERT) then
  inquire(unit=819, pos=where)
  read(819,pos=where,IOSTAT=eastatus) ((alP(i,j),i=1,Nx),j=1,Ny)
endif
if (SLPERT) then
  inquire(unit=820, pos=where)
  read(820,pos=where,IOSTAT=eastatus) ((slP(i,j),i=1,Nx),j=1,Ny)
endif
if ((ALRADT == 1) .OR. (OSHDTN == 1)) then
  inquire(unit=821, pos=where)
  read(821,pos=where,IOSTAT=eastatus) ((Sdird(i,j),i=1,Nx),j=1,Ny)
endif
